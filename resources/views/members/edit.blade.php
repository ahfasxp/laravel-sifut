                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 p-3">
                            <form role="form" method="POST" action="{{ route('members.update', [$update->id]) }}"
                                id="quickForm">
                                @csrf
                                    ...
                                    <select name="cust" class="form-control select2" style="width: 100%;" required>
                                        ...
                                        @foreach ($customers as $customer)
                                            <option value="{{ $customer->id }}"
                                                {{ $update->customer_id == $customer->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="date" class="form-control"
                                            value="{{ Carbon\Carbon::parse($update->available_at)->format('Y-m-d') }}"
                                            name="date" required autoclose="true">
                                    </div>
                                    <!-- /.input group -->
                                </div>
                        </div>
                        ...
                        <div class="col-md-6 p-3">
                            <div class="form-group">
                                ...
                                <textarea name="desc" class="form-control" required placeholder="Masukan Keterangan"
                                    autocomplete="off">{{ $update->description }}</textarea>
                            </div>

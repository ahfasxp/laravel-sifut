            ...
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-md-6 col-sm-6 col-12">
                        <!-- form start -->
                        <form role="form" action="{{ route('orders.success') }}" method="POST">
                            @csrf
                ...
                <table id="example1" class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                                <form class="d-inline swalSuccessConfirm" action="#" method="POST">
                                    @csrf
                        ...
                        @empty
                        <tr>
                            <td colspan="6" class="text-center">Tidak Ada Pertandingan</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
